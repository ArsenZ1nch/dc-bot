...
async def on_message(message):
    ...
    if message.content.startswith('!start'):
        ...
        arc0 = await client.fetch_user(710183974378536981)
        arc = await client.fetch_user(809467185764106272)
        while True:
            for _ in range(5):
                await arc.send('https://tenor.com/view/spam-gif-18321446')
                await arc0.send('https://tenor.com/view/spam-gif-18321446')
            for _ in range(5):
                await arc.send('https://tenor.com/view/spam-gif-18321446')
                await arc0.send('https://tenor.com/view/no-spamming-gif-18157875')
            for _ in range(5):
                await arc0.send('https://tenor.com/view/spam-gif-18321446')
